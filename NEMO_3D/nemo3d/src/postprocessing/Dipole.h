...
*****************************************************************************
$Header: /repo/nemo3d/src/postprocessing/Dipole.h,v 1.1 2004/08/26 21:28:07
swlee Exp $
*****************************************************************************/
...
public:
  ...
  inline int &nn(int iat, int nadj) { return _nn[iat * 4 + nadj]; }
  inline double &lattice(int iat, int dim) { return _lattice[iat * 3 + dim]; }
  inline complex *get_H_dipole_X(void) { return _H_dipole_X; }
  inline complex *get_H_dipole_Y(void) { return _H_dipole_Y; }
  inline complex *get_H_dipole_Z(void) { return _H_dipole_Z; }
