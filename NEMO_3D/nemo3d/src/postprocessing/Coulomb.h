...
*****************************************************************************
$Header: /repo/nemo3d/src/postprocessing/Coulomb.h,v 1.1 2004/08/26 21:28:07
swlee Exp $
*****************************************************************************/
...
public:
  ...
  inline complex &H_coul(int n1, int n2) { return _H_coul[n1 * h_max + n2]; }

  inline complex &H_exch(int n1, int n2) { return _H_exch[n1 * h_max + n2]; }

  inline int &nn(int g1, int nadj) { return _nn[g1 * 4 + nadj]; }

  inline double &lattice(int g1, int dim) { return _lattice[g1 * 3 + dim]; }

  inline complex *get_H_coul(void) { return _H_coul; }
  inline complex *get_H_exch(void) { return _H_exch; }
