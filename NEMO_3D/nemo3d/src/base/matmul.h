...
// changed h[0][0] to val (it looks trivial, however, it helps to speed up a little
#define cmatmul_sparse_spds_1(  y,  val,  x,  isy,  isx )     {y[isy].r += val*x[isx].r ;y[isy].i += val*x[isx].i ;}
#define cmatmul_sparse_spds_hc_1(  y,  val,  x,  isy,  isx ) {y[isy].r += val*x[isx].r ;y[isy].i += val*x[isx].i ;}
// Hoon and sunnylee
