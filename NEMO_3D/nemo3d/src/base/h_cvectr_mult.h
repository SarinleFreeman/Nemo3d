...
*****************************************************************************
$Header: /repo/nemo3d/src/base/h_cvectr_mult.h,v 1.11 2005/12/24 03:37:14 gekco
Exp $
*****************************************************************************/
...
int Hmult_spds_col_fullstored_par(cvectr y, cvectr yc, qd_struct d, real s,
                                  cvectr x, int proc);
int Hmult_spds_col(cvectr y, cvectr yc, qd_struct d, real s, cvectr x,
                   int proc);
int Hmult_spds_col_prep_store(cvectr y, cvectr yc, qd_struct d, real s,
                              cvectr x, int proc);
...
void H_Diag_Wrapper(qd_struct, int l, int m, int i, int j, int k,
