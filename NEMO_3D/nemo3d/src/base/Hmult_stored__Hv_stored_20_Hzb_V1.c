...
*****************************************************************************
$Header: /repo/nemo3d/src/base/Hmult_stored__Hv_stored_20_Hzb_V1.c,v 1.5 2005/02/04 20:13:06 gekco Exp $ 
*****************************************************************************/
...
void Hv_stored_20_Hzb_V1( cvectr y, cvectr yc, cvectr x, qd_struct d)
{
  ...
  /* printf("Vector-time:  T_V1_diag=%g T_V1_mag=%g T_V1_Hdu=%g T_V1_Hds=%g T_V1_Hu=%g T_V1_Ho=%g\n",T_V1_diag, T_V1_mag, T_V1_Hdu, T_V1_Hds, T_V1_Hu, T_VV1Ho), fflush(stdout); */
#endif
