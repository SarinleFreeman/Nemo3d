...
*****************************************************************************
$Header: /repo/nemo3d/src/base/Hmult_stored__Hv_stored_20_Hzb_V0.c,v 1.5 2005/02/04 20:13:06 gekco Exp $ 
*****************************************************************************/
...
void Hv_stored_20_Hzb_V0( cvectr y, cvectr yc, cvectr x, qd_struct d)
{
   const int Nb_2=10;
  ...
  /* printf("Vector-time:  T_V0_diag=%g T_V0_mag=%g T_V0_Hdu=%g T_V0_Hds=%g T_V0_Hu=%g T_V0_Ho=%g\n",T_V0_diag, T_V0_mag, T_V0_Hdu, T_V0_Hds, T_V0_Hu, T_V0_Ho), fflush(stdout); */
#endif
