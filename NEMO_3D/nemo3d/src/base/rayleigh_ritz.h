...
*****************************************************************************
$Header: /repo/nemo3d/src/base/rayleigh_ritz.h,v 1.5 2004/10/27 19:43:10 gekco
Exp $
*****************************************************************************/
...
#ifdef MPI3d
void calc_rayleigh_sq_macopt(rvectr p, int sz, rvectr xi, int, void *data,
                             int itercount, real *onevalue);
void calc_rayleigh_sq_cmacopt(cvectr p, int sz, cvectr xi, int, void *data,
                              int itercount, real *onevalue);
#else  /* MPI3d */
