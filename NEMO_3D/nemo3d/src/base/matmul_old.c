...
*****************************************************************************
$Header: /repo/nemo3d/src/base/matmul_old.c,v 1.1 2006/11/23 19:47:59 hoonryu Exp $ 
*****************************************************************************/
...
#undef  DO_ONE_BAND_REAL_ONLY
#ifdef  DO_ONE_BAND_REAL_ONLY
...
#define cmatmul_spds_1(  y,  h,  x,  isy,  isx, hdim )     {y[isy].r += h[0][0].r*x[isx].r; y[isy].i += h[0][0].r*x[isx].i;}
#define cmatmul_spds_hc_1(  y,  h,  x,  isy,  isx,  hdim ) {y[isy].r += h[0][0].r*x[isx].r; y[isy].i += h[0][0].r*x[isx].i;}
#else /* CMATMUL_SPDS_1_MACRO */
int cmatmul_spds_1( cvectr y, cmatrix h, cvectr x, int isy, int isx, int hdim )
{
    y[isy].r += h[0][0].r*x[isx].r;
    y[isy].i += h[0][0].r*x[isx].i;
    return 0;
...
#ifdef  CMATMUL_SPDS_1_MACRO
#define cmatmul_spds_1(  y,  h,  x,  isy,  isx, hdim )     {y[isy].r += h[0][0].r*x[isx].r - h[0][0].i*x[isx].i;y[isy].i += h[0][0].r*x[isx].i + h[0][0].i*x[isx].r;}
#define cmatmul_spds_hc_1(  y,  h,  x,  isy,  isx,  hdim ) {y[isy].r += h[0][0].r*x[isx].r + h[0][0].i*x[isx].i;y[isy].i += h[0][0].r*x[isx].i - h[0][0].i*x[isx].r;}
#else /* CMATMUL_SPDS_1_MACRO */
int cmatmul_spds_1( cvectr y, cmatrix h, cvectr x, int isy, int isx, int hdim )
{
