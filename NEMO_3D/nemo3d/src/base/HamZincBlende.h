...
*****************************************************************************
$Header: /repo/nemo3d/src/base/HamZincBlende.h,v 1.12 2004/10/29 02:54:34 gekco Exp $ 
*****************************************************************************/
...
class HamZincBlende {
 ...
 public:
   ...
   complex HBxy; // off-diagonal element of H_{atom-atom} due to magnetic field in x or y direction.
   ...
   ham_mem_rvectr Ho;  // matrix of off-diag elements of H on neighboring processor
   ...
   HamZincBlende() { 
      Hdd=0; Hdu=0; Hds=0; Hu=0; Ho=0; HphaseIn=0; HphaseOut=0;
