...
void map_chebyshev_shift_wrapper(int *, int *, int *, complex *, complex *,
                                 complex *, complex *, complex *, int *, real *,
                                 real *, real *, int *, int *);
void zgtracemin_wrapper(int *, int *, complex *, real *, complex *, complex *,
                        complex *, complex *, complex *, complex *, real *,
                        int *, complex *, real *, int *, int *, int *, int *,
                        int *, int *, int *);
void pcextract_eigenpairs_wrapper(complex *, real *, int *, int *, complex *,
