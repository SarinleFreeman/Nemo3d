...
public:
  ...
  void print() {
    printf("------------------  CPU %2d ------------------\n", mpi_n3d_id);
    printf("cpu: %3d TOTAL:        total=%5.1f\t setup=%5.1f\t strain=%5.1f "
           "electronics=%5.1f fileio=%5.1f\n",
           mpi_n3d_id, total, setup, strain, work, fileio);
    printf("cpu: %3d MATRIX:       h3ddia=%5.1f\t h3doff=%5.1f\t "
           "multiply_nocom=%5.1f\t  multiply_tot=%5.1f\n",
           mpi_n3d_id, h3ddiag, h3doffd, matmul_spds, Hv_tot);
    printf("cpu: %3d COMM1:         sendrec=%5.1f\t allred=%5.1f\t "
           "barrier=%5.1f\t bcast=%5.1f\t send=%5.1f\t receive=%5.1f\n",
           mpi_n3d_id, other_mpi[0] + strain_mpi[0] + electr_mpi[0],
