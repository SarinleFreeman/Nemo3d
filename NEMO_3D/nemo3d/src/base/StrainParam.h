...
public:
  ...
  rmatrix aa_VFF, ba_VFF,
      ca_VFF; // Coefficients of the strain dependence of the VFF constants in
              // the Keating model. Used for the strain calculations and the
              // low-energy acousticl phonons
  rmatrix ao_VFF, bo_VFF,
      co_VFF; // Coefficients of the strain dependence of the VFF constants in
              // the Keating model. Used for optical phonons.

  /* mapping stuff for strain */
  ivectr lm_sndL, lm_sndR, lm_rcvL, lm_rcvR;
  int cellLMin, cellLMax, atomLMin, atomLMax, cellRMin, cellRMax, atomRMin,
      atomRMax;
  ...
  */
  ...
  real beta_eff(int m_atom_type,  // type of the m-th atom
                ...
                rvectr d1,
                rvectr d2, // vectors of the relaxed bonds of the V doublet
                rvectr r1,
                rvectr r2, // vectors of the strained bonds of the V doublet
                int anh,   // 1-use acoustical anharmonicity corrections
                // 2-use optical anharmonicity corrections
                // 3-use linear interpolation
