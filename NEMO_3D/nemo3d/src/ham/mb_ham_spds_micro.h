...
*****************************************************************************
$Header: /repo/nemo3d/src/ham/mb_ham_spds_micro.h,v 1.16 2007/06/12 20:15:22
nkharche Exp $
*****************************************************************************/
...
int h3d_offdiag(cmatrix h, rvectr nnv, ivectr basis0, ivectr basisn,
                ...
                real unstrnd_lattice_const, int nb2);

int h3d_offdiag_diag_corr(cmatrix ho, cmatrix hd, rvectr nnv, rvectr nnv0,
                          ivectr basis0, ivectr basisn, ivectr spin,
                          rvectr param, rvectr mb_strain,
                          real unstrnd_lattice_const, int nb2);

int h3d_diag(cmatrix h, ivectr basis0, ivectr spin, rvectr param, int nb2);

int h3d_diag_strain_corr(cmatrix ho, cmatrix hd, rvectr nnv, ivectr basis0,
                         ivectr basisn, ivectr spin, rvectr param,
                         rvectr mb_strain, real unstrnd_lattice_const, int nb2);
...
void h3d_diag_dangling_bond_shift_ZB_rot(
    qd_struct d, int cindx, int aindx); /* Added for ZB_110 and ZB_111 */
...
/* Gets off diagonal elements and multiplys by appropriate phase
   factor */
complex ei(rvectr v, rvectr mb_strain, real unstrnd_cubic_cell_length, rvectr k,
           rvectr d, rvectr d0, int ba, int bc, real *E_diag_corr);

complex eidk(rvectr v, rvectr mb_strain, real unstrnd_cubic_cell_length,
...
int tbh_const_bulk_3d(cmatrix h, rmatrix nnv, ivectr basis, ivectr spin,
                      rvectr param, rvectr mb_strain,
                      real unstrnd_cubic_cell_length, rvectr k);
...
rvectr param_sp3s_2_sp3d5s(rvectr param_in, rvectr param_out,
                           real unstrnd_lattice_const, real delX, real delY,
                           real delZ);
