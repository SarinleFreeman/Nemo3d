...
*****************************************************************************
$Header: /repo/nemo3d/src/util/util_argv_loc_B.h,v 1.2 2003/10/08 16:18:52 hook
Exp $
*****************************************************************************/
 ...
 *
 * $Id: util_argv_loc_B.h,v 1.2 2003/10/08 16:18:52 hook Exp $
 */

#ifndef __UTIL_ARGV_LOC_B_H__
#define __UTIL_ARGV_LOC_B_H__

#include "util_argv_B.h" /* to get the types */
...
#define SCREEN_WIDTH 99                    /* width of screen till wrap */
...
#define HAS_ARG(type)                                                          \
  (!(ARGV_TYPE(type) == ARGV_BOOL || ARGV_TYPE(type) == ARGV_BOOL_NEG ||       \
...
LOCAL argv_type_t argv_types[] = {
    {ARGV_BOOL, "flag", sizeof(char), "if option used, set variable to true"},
    ...
    {ARGV_CHAR, "character", sizeof(char), "single character"},
    ...
    {ARGV_INT, "integer", sizeof(int), "decimal integer value"},
    ...
    {ARGV_BIN, "binary", sizeof(int), "base 2 value with digits of 0 or 1"},
    {ARGV_OCT, "octal", sizeof(int), "base 8 value with digits from 0-7"},
