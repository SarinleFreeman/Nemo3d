...
*****************************************************************************
$Header: /repo/nemo3d/src/math/cmatrixmatrix.c,v 1.3 2004/10/27 19:43:10 gekco Exp $                
*****************************************************************************/
...
/*T_HEADER_SHORT{rm_cmatrixmatrix_shell_only}
  Free up memory assigned to the Cmatrixmatrix structure. Do not free the memory of the submatrices. 
   T*/
