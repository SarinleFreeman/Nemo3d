...
*****************************************************************************
$Header: /repo/nemo3d/src/math/cmatrix_nonsym.h,v 1.3 2005/04/22 20:16:03 dseaman Exp $
*****************************************************************************/
...
#define zhseqr            ZHSEQR
    ...
    void zheev(char*, char*, int*, nml_dcscalar*, int*, double*, cvectr, int*, double*, int*);
    void zgehrd(int*, int*, int*, nml_dcscalar*, int*, cvectr, cvectr, int*, int*);
    void zhseqr(char*, char*, int*, int*, int*, nml_dcscalar*, int*, cvectr, nml_dcscalar*, int*, cvectr, int*, int*);
