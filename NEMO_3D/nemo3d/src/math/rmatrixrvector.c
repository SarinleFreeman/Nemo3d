...
*****************************************************************************
$Header: /repo/nemo3d/src/math/rmatrixrvector.c,v 1.3 2004/10/27 19:43:10 gekco Exp $
*****************************************************************************/
...
/*T_HEADER_SHORT{rm_rmatrixrvectr_shell_only}
  Free up memory assigned to the Rmatrixrvectr structure. Do not free the memory of the submatrices. 
   T*/
