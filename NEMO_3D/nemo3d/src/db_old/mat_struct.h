...
*****************************************************************************
$Header: /repo/nemo3d/src/db_old/mat_struct.h,v 1.1 2004/02/16 03:36:56 gekco
Exp $
*****************************************************************************/
...
typedef struct SEMI_MATERIAL {
  ...
  cmatrix mb_d, mb_s;
  rvectr mb_param;
  int mb_bdim, mb_abdim, mb_spin_orbit, mb_band_inc, mb_nbr, mb_param_n,
      mb_spin_degeneracy, mb_sigma_singular;
  char *mb_model;
  real mb_unit_cell;
