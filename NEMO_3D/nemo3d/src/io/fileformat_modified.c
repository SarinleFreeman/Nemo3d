...
*****************************************************************************
$Header: /repo/nemo3d/src/io/fileformat_modified.c,v 1.1 2007/03/25 16:23:35 hoonryu Exp $
*****************************************************************************/
...
void read_oneLine(FILE *fp, char* xbuffer, char* ybuffer, char* zbuffer, char* databuffer, int* xi, int* yi, int* zi, double* value) { 
 ...
 fread(databuffer,19,1,fp);xbuffer[19]='\0';fgetc(fp);fgetc(fp);fgetc(fp);fgetc(fp);
 *xi = atof(xbuffer);
 *yi = atof(ybuffer);
 *zi = atof(zbuffer);
