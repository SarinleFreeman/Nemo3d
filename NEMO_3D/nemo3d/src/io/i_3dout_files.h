...
*****************************************************************************
$Header: /repo/nemo3d/src/io/i_3dout_files.h,v 1.23 2008/09/24 02:09:19 hoonryu
Exp $
*****************************************************************************/
...
void writeEigenvector(qd_struct d, complex *wf, int indx,
                      const char *suffix = "");
void writeMomentumMatrix(qd_struct d, complex *wf, int indx,
                         const char *suffix = "");
void writeTransitionRate(qd_struct d, real *wf, int indx,
                         const char *suffix = "");
