#ifndef _nml_smatrix_h
#define _nml_smatrix_h 1
...
typedef nml_sscalar*	nml_smatrix;
...
#else /*NML_INLINE	*/
/* Functions								*/
nml_extent		(nml_sm_extent1)(const nml_smatrix*);
nml_extent		(nml_sm_extent2)(const nml_smatrix*);
/* Constructor								*/
nml_smatrix*	(nml_sm_new)(nml_extent, nml_extent);
/* Destructor								*/
void			(nml_sm_delete)(nml_smatrix*);
/* Reconstructor							*/
nml_smatrix*	(nml_sm_resize)(nml_smatrix**,
  nml_extent, nml_extent);
#endif/*NML_INLINE	*/

int			(nml_sm_fprintf)(FILE*,
    const nml_smatrix*, int, unsigned int, nml_fmtflags, unsigned int);
