#ifndef _nml_d3bands_h
#define _nml_d3bands_h 1
...
|                                                       T[-1][m-1] T[ 0][m-1]|
where nml_extent m = nml_d3_extent(pT);				*/

/* Include vector type definitions.					*/
#include<nml_dvector.h>

typedef nml_dscalar*	nml_d3bands;
...
nml_d3bands*	(nml_d3_new)(nml_extent n) {
  nml_dscalar**	pT
    = (nml_dscalar**)nml_calloc(4*sizeof(nml_dscalar*));
  if (NULL == pT) {
...
#else /*NML_INLINE	*/
/* Functions								*/
nml_extent		(nml_d3_extent)(const nml_d3bands*);
nml_d3bands*	(nml_d3_fill)(
    nml_d3bands*, const nml_dscalar);
nml_d3bands*	(nml_d3_smul)(
    nml_d3bands*, const nml_dscalar);
nml_d3bands*	(nml_d3_sdiv)(
    nml_d3bands*, const nml_dscalar);
...
nml_d3bands*	(nml_d3_ssub)(
    nml_d3bands*, const nml_dscalar);
nml_d3bands*	(nml_d3_3cpy)(
    nml_d3bands*, const nml_d3bands*);
nml_dvector*	(nml_dv_v3dot)(
    nml_dvector*, const nml_dvector*, const nml_d3bands*);
nml_dvector*	(nml_dv_solveTridiagonal)(
    nml_dvector*, const nml_d3bands*, const nml_dvector*);
/* Constructor								*/
nml_d3bands*	(nml_d3_new)(nml_extent);
nml_d3bands*	(nml_d3_clone)(const nml_d3bands* pU);
/* Destructor								*/
void			(nml_d3_delete)(nml_d3bands*);
/* Reconstructor							*/
nml_d3bands*	(nml_d3_resize)(nml_d3bands**,
			    nml_extent);
#endif/*NML_INLINE	*/

int			(nml_d3_fprintf)(FILE*,
    const nml_d3bands*, int, unsigned int, nml_fmtflags, unsigned int);

#ifdef	NML_MACROS
#define nml_d3_extent(pT) (*((const nml_extent*)((pT) - 2)))
#define nml_d3_clone(pT) \
	nml_d3_3cpy(nml_d3_new(nml_d3_extent(pT)), (pT))
#endif/*NML_MACROS	*/

#endif /* _nml_d3bands_h */
