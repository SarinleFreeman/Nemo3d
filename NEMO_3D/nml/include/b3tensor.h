...
#include "tensor.h"
/* Include nml_b3DBase type definition.					*/
#include "nml_b3DBase.h"

typedef nml_b3DBase* b3tensor;
...
#else /*NML_INLINE	*/
/* Constructor								*/
b3tensor	B3tensor(int, int, int, int, int, int);
/* Destructor								*/
void		rm_b3tensor(b3tensor*, int);
/* Reconstructor							*/
b3tensor	check_b3tensor(b3tensor, int, int, int, int, int, int);
#endif/*NML_INLINE	*/
