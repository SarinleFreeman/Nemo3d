#ifndef _nml_b2DBase_h
#define _nml_b2DBase_h 1
...
typedef nml_bscalar*	nml_b2DBase;

#ifdef	NML_INLINE
/* Functions								*/
inline static
...
#else /*NML_INLINE	*/
/* Functions								*/
nml_index		(nml_b2D_lower2)(const nml_b2DBase*);
nml_index		(nml_b2D_upper2)(const nml_b2DBase*);
nml_extent		(nml_b2D_extent2)(const nml_b2DBase*);

nml_index		(nml_b2D_lower1)(const nml_b2DBase*);
nml_index		(nml_b2D_upper1)(const nml_b2DBase*);
nml_extent		(nml_b2D_extent1)(const nml_b2DBase*);
/* Constructor								*/
nml_b2DBase*	(nml_b2D_new)(
    nml_index, nml_index, nml_index, nml_index);
/* Destructor								*/
void			(nml_b2D_delete)(nml_b2DBase*);
/* Reconstructor							*/
nml_b2DBase*	(nml_b2D_resize)(nml_b2DBase**,
    nml_index, nml_index, nml_index, nml_index);
#endif/*NML_INLINE	*/

int			(nml_b2D_fprintf)(FILE*,
    const nml_b2DBase*, int, unsigned int, nml_fmtflags, unsigned int);
