#ifndef _nml_dmatrix_h
#define _nml_dmatrix_h 1
...
typedef nml_dscalar*	nml_dmatrix;
...
#else /*NML_INLINE	*/
/* Functions								*/
nml_extent		(nml_dm_extent1)(const nml_dmatrix*);
nml_extent		(nml_dm_extent2)(const nml_dmatrix*);
/* Constructor								*/
nml_dmatrix*	(nml_dm_new)(nml_extent, nml_extent);
/* Destructor								*/
void			(nml_dm_delete)(nml_dmatrix*);
/* Reconstructor							*/
nml_dmatrix*	(nml_dm_resize)(nml_dmatrix**,
  nml_extent, nml_extent);
#endif/*NML_INLINE	*/

int			(nml_dm_fprintf)(FILE*,
    const nml_dmatrix*, int, unsigned int, nml_fmtflags, unsigned int);
