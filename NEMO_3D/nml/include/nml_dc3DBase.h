#ifndef _nml_dc3DBase_h
#define _nml_dc3DBase_h 1
...
/* Include double precision real 3DBase type definitions.		*/
#include<nml_d3DBase.h>

/* Include scalar type definitions.					*/
#include<nml_dcscalar.h>

typedef nml_dcscalar**	nml_dc3DBase;

#ifdef	NML_INLINE
/* Functions								*/
inline static
...
#else /*NML_INLINE	*/
/* Functions								*/
nml_index		(nml_dc3D_lower3)(const nml_dc3DBase*);
nml_index		(nml_dc3D_upper3)(const nml_dc3DBase*);
nml_extent		(nml_dc3D_extent3)(const nml_dc3DBase*);

nml_index		(nml_dc3D_lower2)(const nml_dc3DBase*);
nml_index		(nml_dc3D_upper2)(const nml_dc3DBase*);
nml_extent		(nml_dc3D_extent2)(const nml_dc3DBase*);

nml_index		(nml_dc3D_lower1)(const nml_dc3DBase*);
nml_index		(nml_dc3D_upper1)(const nml_dc3DBase*);
nml_extent		(nml_dc3D_extent1)(const nml_dc3DBase*);
/* Constructor								*/
nml_dc3DBase*	(nml_dc3D_new)(
    nml_index, nml_index, nml_index, nml_index, nml_index, nml_index);
/* Destructor								*/
void			(nml_dc3D_delete)(nml_dc3DBase*);
/* Reconstructor							*/
nml_dc3DBase*	(nml_dc3D_resize)(nml_dc3DBase**,
    nml_index, nml_index, nml_index, nml_index, nml_index, nml_index);
#endif/*NML_INLINE	*/

int			(nml_dc3D_fprintf)(FILE*,
    const nml_dc3DBase*, int, unsigned int, nml_fmtflags, unsigned int);
