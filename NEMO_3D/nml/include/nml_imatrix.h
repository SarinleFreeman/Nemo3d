#ifndef _nml_imatrix_h
#define _nml_imatrix_h 1
...
typedef nml_iscalar*	nml_imatrix;
...
#else /*NML_INLINE	*/
/* Functions								*/
nml_extent		(nml_im_extent1)(const nml_imatrix*);
nml_extent		(nml_im_extent2)(const nml_imatrix*);
/* Constructor								*/
nml_imatrix*	(nml_im_new)(nml_extent, nml_extent);
/* Destructor								*/
void			(nml_im_delete)(nml_imatrix*);
/* Reconstructor							*/
nml_imatrix*	(nml_im_resize)(nml_imatrix**,
  nml_extent, nml_extent);
#endif/*NML_INLINE	*/

int			(nml_im_fprintf)(FILE*,
    const nml_imatrix*, int, unsigned int, nml_fmtflags, unsigned int);
