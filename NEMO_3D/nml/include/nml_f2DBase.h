#ifndef _nml_f2DBase_h
#define _nml_f2DBase_h 1
...
typedef nml_fscalar*	nml_f2DBase;

#ifdef	NML_INLINE
/* Functions								*/
inline static
...
#else /*NML_INLINE	*/
/* Functions								*/
nml_index		(nml_f2D_lower2)(const nml_f2DBase*);
nml_index		(nml_f2D_upper2)(const nml_f2DBase*);
nml_extent		(nml_f2D_extent2)(const nml_f2DBase*);

nml_index		(nml_f2D_lower1)(const nml_f2DBase*);
nml_index		(nml_f2D_upper1)(const nml_f2DBase*);
nml_extent		(nml_f2D_extent1)(const nml_f2DBase*);
/* Constructor								*/
nml_f2DBase*	(nml_f2D_new)(
    nml_index, nml_index, nml_index, nml_index);
/* Destructor								*/
void			(nml_f2D_delete)(nml_f2DBase*);
/* Reconstructor							*/
nml_f2DBase*	(nml_f2D_resize)(nml_f2DBase**,
    nml_index, nml_index, nml_index, nml_index);
#endif/*NML_INLINE	*/

int			(nml_f2D_fprintf)(FILE*,
    const nml_f2DBase*, int, unsigned int, nml_fmtflags, unsigned int);
