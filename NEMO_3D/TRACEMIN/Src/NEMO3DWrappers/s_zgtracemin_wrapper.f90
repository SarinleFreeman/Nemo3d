subroutine zgtracemin_wrapper(n,neig,Y,E,Q,Qt,H,Hloc,G,ZWork,RWork,IWork,R,tol,maxi,ncall,nloc,rank,np,comm,info)
    use tracemin_types
    ...
    double complex,  dimension(neig,nloc),      intent(inout):: Qt     !temporary variable, with dimensions of transpose of Q
    ...
    double complex,  dimension(neig,neig),      intent(inout):: G      !temporary variable, contains Y'*A*Y
    ...
    !write(*,*) 'entering info',info
    !write(*,*) 'entering eigs',E

    call zgtracemin(n,neig,Y,E,Q,Qt,H,Hloc,G,ZWork,RWork,IWork,R,tol,maxi,ncall,nloc,rank,np,comm,info)

    !write(*,*) 'exiting info',info
    !write(*,*) 'exiting eigs',E
    !write(*,*) 'exiting eigs',Y(90:100,1)
    

end subroutine zgtracemin_wrapper
