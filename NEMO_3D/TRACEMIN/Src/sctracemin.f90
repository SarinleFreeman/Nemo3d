program sctracemin
      ...
      !generate random eigenvector guess and initialize eigenvalues to zero
      ...
      !write(*,*) 'call tracemin'       
      !t= timer()      
      call test_zgtracemin(M,ai,result_v,result_e,R, 0,0,0,info)  
      !t2= timer()

      !Print results
      !do i=1,ai%neig
      !   write(*,*) 'eigenvector', R(:,i)
      !end do
