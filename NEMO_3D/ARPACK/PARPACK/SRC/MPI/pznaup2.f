c ---------------------------------------------------------------
c  Certain Fortran compilers on MACOSX do not like the long line
c  spacing of Fortran code in PARPACK's
c  NEMO3D/ARPACK/PARPACK/SRC/MPI/pznaup2.f: line 253-254
c  Some compilers will think "pznapps" and "zsortc" are really
c  the same one variable "pznappszsortc".
c
c  This modified "pznaup2.f" has the change 
c  that simply shortens the line spacing of:
c
c        external   zcopy,pzgetv0,pznaitr,pzneigh,pzngets,pznapps,
c        &          zsortc,zswap,pzmout,pzvout,pivout,second
c ---------------------------------------------------------------
...
c
     ...
     &           pznapps , zsortc , zswap , pzmout ,
     &           pzvout , pivout, second
c
c     %--------------------%
