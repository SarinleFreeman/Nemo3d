...
void read_wfs(int, const char*, int, int, complex<double>*, complex<double>*);
void read_wfs1(int, const char* , int, complex<double>*);
void read_wfs_prob(int, const char*,  int, double*);
void read_write_wf_10(const char* base, int, int*, int);
