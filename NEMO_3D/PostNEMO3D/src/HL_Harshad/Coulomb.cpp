...
// allocation of pre-computed values.
 ...
 for(int x1=g_min1;x1<g_max1;x1++) {
     ...
     for(int o1=0;o1<2;o1++) {
         ...
         t1_o1_Real[count]   = c0101.real()*c0101.real() + c0101.imag()*c0101.imag() + c0111.real()*c0111.real() + c0111.imag()*c0111.imag();
         t4_o1_Real[count]   = c0101.real()*cR101.real() + c0101.imag()*cR101.imag() + c0111.real()*cR111.real() + c0111.imag()*cR111.imag();
         t4_o1_Imag[count++] = c0101.real()*cR101.imag() - c0101.imag()*cR101.real() + c0111.real()*cR111.imag() - c0111.imag()*cR111.real();
 ...
 for(int x2=g_min2;x2<g_max2;x2++) {
     ...
     for(int o1=0;o1<2;o1++) {
         ...
         t1_o2_Real[count]   = c1201.real()*c1201.real() + c1201.imag()*c1201.imag() + c1211.real()*c1211.real() + c1211.imag()*c1211.imag();
         t4_o2_Real[count]   = c1201.real()*cR201.real() + c1201.imag()*cR201.imag() + c1211.real()*cR211.real() + c1211.imag()*cR211.imag();
         t4_o2_Imag[count++] = c1201.real()*cR201.imag() - c1201.imag()*cR201.real() + c1211.real()*cR211.imag() - c1211.imag()*cR211.real();
         ...
         if(dd < dd_cutoff_sq) {
            ...
            for(int o1=0;o1<o_max_new;o1++){
                ...
                for(int o2=o1+1;o2<o_max_new;o2++){
                    ...
                    t1.real() += (t1_o1_Real[count1]*t1_o2_Real[count3] + t1_o1_Real[count4]*t1_o2_Real[count2])*coul_tmp;
                    t4.real() += (t4_o1_Real[count1]*t4_o2_Real[count3] - t4_o1_Imag[count1]*t4_o2_Imag[count3] + t4_o1_Real[count4]*t4_o2_Real[count2] - t4_o1_Imag[count4]*t4_o2_Imag[count2])*coul_tmp;
                    t4.imag() += (t4_o1_Imag[count1]*t4_o2_Real[count3] + t4_o1_Real[count1]*t4_o2_Imag[count3] + t4_o1_Imag[count4]*t4_o2_Real[count2] + t4_o1_Real[count4]*t4_o2_Imag[count2])*coul_tmp;
                ...
                if(o1==2) {
                   ...
                   for (int oindx = 2; oindx < 5; oindx++) {
                        ...
                        temp_t1_o1_Real         = c0101.real()*c0101.real() + c0101.imag()*c0101.imag() + c0111.real()*c0111.real() + c0111.imag()*c0111.imag();
                        temp_t1_o2_Real_Reverse = c1201.real()*c1201.real() + c1201.imag()*c1201.imag() + c1211.real()*c1211.real() + c1211.imag()*c1211.imag();
                        temp_t4_o1_Real         = c0101.real()*cR101.real() + c0101.imag()*cR101.imag() + c0111.real()*cR111.real() + c0111.imag()*cR111.imag();
                        temp_t4_o1_Imag         = c0101.real()*cR101.imag() - c0101.imag()*cR101.real() + c0111.real()*cR111.imag() - c0111.imag()*cR111.real();
                        temp_t4_o2_Real_Reverse = c1201.real()*cR201.real() + c1201.imag()*cR201.imag() + c1211.real()*cR211.real() + c1211.imag()*cR211.imag();
                        temp_t4_o2_Imag_Reverse = c1201.real()*cR201.imag() - c1201.imag()*cR201.real() + c1211.real()*cR211.imag() - c1211.imag()*cR211.real();

                        t1.real() += (temp_t1_o1_Real*temp_t1_o2_Real_Reverse)*coul_tmp;
                        t4.real() += (temp_t4_o1_Real*temp_t4_o2_Real_Reverse - temp_t4_o1_Imag*temp_t4_o2_Imag_Reverse)*coul_tmp;
                        t4.imag() += (temp_t4_o1_Imag*temp_t4_o2_Real_Reverse + temp_t4_o1_Real*temp_t4_o2_Imag_Reverse)*coul_tmp;
                ...
                t1.real() += (t1_o1_Real[count1]*t1_o2_Real[count2])*coul_tmp;
                t4.real() += (t4_o1_Real[count1]*t4_o2_Real[count2] - t4_o1_Imag[count1]*t4_o2_Imag[count2])*coul_tmp;
                t4.imag() += (t4_o1_Imag[count1]*t4_o2_Real[count2] + t4_o1_Real[count1]*t4_o2_Imag[count2])*coul_tmp; 
              ...
              t1.real() += (t1_o1_Real_Cutoff*t1_o2_Real_Cutoff)*coul_tmp;
              t4.real() += (t4_o1_Real_Cutoff*t4_o2_Real_Cutoff - t4_o1_Imag_Cutoff*t4_o2_Imag_Cutoff)*coul_tmp;
              t4.imag() += (t4_o1_Imag_Cutoff*t4_o2_Real_Cutoff + t4_o1_Real_Cutoff*t4_o2_Imag_Cutoff)*coul_tmp;
        ...
        for(int o1=0;o1<o_max;o1++) {
            ...
            for(int o2=o1+1;o2<o_max;o2++){
                ...
                if(exch_tmp!=0.0) {              
                   ...
                   t2_1.real() = c0101.real()*c0102.real() + c0101.imag()*c0102.imag() + c0111.real()*c0112.real() + c0111.imag()*c0112.imag();
                   t2_1.imag() = c0101.real()*c0102.imag() - c0101.imag()*c0102.real() + c0111.real()*c0112.imag() - c0111.imag()*c0112.real();

                   t2_2.real() = c1101.real()*c1102.real() + c1101.imag()*c1102.imag() + c1111.real()*c1112.real() + c1111.imag()*c1112.imag();
                   t2_2.imag() = c1101.real()*c1102.imag() - c1101.imag()*c1102.real() + c1111.real()*c1112.imag() - c1111.imag()*c1112.real();

                   t5_1.real() = c0101.real()*c1102.real() + c0101.imag()*c1102.imag() + c0111.real()*c1112.real() + c0111.imag()*c1112.imag();
                   t5_1.imag() = c0101.real()*c1102.imag() - c0101.imag()*c1102.real() + c0111.real()*c1112.imag() - c0111.imag()*c1112.real();

                   t6_2.real() = c1101.real()*c0102.real() + c1101.imag()*c0102.imag() + c1111.real()*c0112.real() + c1111.imag()*c0112.imag();
                   t6_2.imag() = c1101.real()*c0102.imag() - c1101.imag()*c0102.real() + c1111.real()*c0112.imag() - c1111.imag()*c0112.real();

                   t2.real() += (t2_1.real()*t2_2.real() - t2_1.imag()*t2_2.imag())*exch_tmp*2;
                   t3.real() += (t2_1.real()*t2_2.real() + t2_1.imag()*t2_2.imag())*exch_tmp*2;
                   t5.real() += (t5_1.real()*t5_1.real() + t5_1.imag()*t5_1.imag() + t6_2.real()*t6_2.real() + t6_2.imag()*t6_2.imag())*exch_tmp;
                   t6.real() += (t5_1.real()*t6_2.real() - t5_1.imag()*t6_2.imag())*exch_tmp*2;
...
double R=0.0; 
  ...
  for(int x1=g_min1;x1<g_max1;x1++){
     ...
     for(int o=0;o<2;o++) {
        ...
        ce1.real() = _cf_e[(x1-g_min1)*2*o_max+o].real();         ce1.imag() = (-1)*_cf_e[(x1-g_min1)*2*o_max+o].imag(); 
        ce3.real() = _cf_e[((x1-g_min1)*2+1)*o_max+o].real();     ce3.imag() = (-1)*_cf_e[((x1-g_min1)*2+1)*o_max+o].imag();
...
void Coulomb::compute_one_component(double dd_cutoff_sq, complex<double>*cf_e_second, complex<double>*t1_1, complex<double>*t4_1, complex<double>*t1_2, complex<double>*t4_2, int N1, int N2, int N3, int N4, int index) {
  ...
  for(int x1=g_min1;x1<g_max1;x1++){
     ...
     for(int o=0;o<2;o++) {
        ...
        ce1.real() = _cf_e[((N1*(g_max1 - g_min1)+x1-g_min1)*2)*o_max+o].real();       ce1.imag() = (-1)*_cf_e[((N1*(g_max1 - g_min1)+x1-g_min1)*2)*o_max+o].imag(); 
        ce3.real() = _cf_e[((N1*(g_max1 - g_min1)+x1-g_min1)*2+1)*o_max+o].real();     ce3.imag() = (-1)*_cf_e[((N1*(g_max1 - g_min1)+x1-g_min1)*2+1)*o_max+o].imag();
